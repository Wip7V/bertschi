...
*/			function imprSelec(muestra)
			...
			function pdfgen() 
			{ 
				document.getElementById("formsal").action = "genpdf.php"; 
				document.getElementById("formsal").target = "_blank"; 
				document.getElementById("formsal").submit();
			} 
...
<div id="principal2">
    ...
    <div class="formulario">
    	<form method="post" id="formsal"  enctype="multipart/form-data">
        	Codigo DUA: 
        	  <select id="ndua_entrada" name="ndua_entrada" onchange="carga()">
        	<option value="0">Selecciona Codigo DUA</option>
<!--            <option value="">Mostrar todo</option>
-->           <?php 
			$sql="SELECT DISTINCT ndua_entrada FROM ctdua WHERE ndua_salida='' ORDER BY ndua_entrada";
        ...
        <table>
        	<tr>
                <td><input type="button" class="boton" value="Imprimir" onclick="imprSelec('impres')"/></td>
           
  <!--              <td><input type="button" class="boton" value="PDF" onclick="pdfgen()"/></td>
      -->     
			</tr>
        </table>
...
<?php
		$sqlcont="SELECT * FROM ctcontenedor WHERE codigo='".$row['ncontenedor']."'";
