    ...
    <body>
       ...
       <div id="principal">
            ...
            <div class="formulario">
                ...
                <div class="botonessup"><a href="formuser.php" class="boton">Nuevo usuario</a></div>
                <br />
            ...
            <tbody>
                <?php while($item=mysql_fetch_array($consulta_mysql)){ ?>
                 <tr>
                    ...
                    <td align="center"><a href="formuser.php?id=<?php echo $item['id']; ?>" title="Editar" ><img src="img/editar.png" border="0" class="boton"/></a>
                     </td>
                    <td align="center"><img src="img/eliminar.png" title="Borrar" onclick="javascript:eliminar(<?php echo $item['id']; ?>);" class="boton" />
                    </td>
                </tr>
                <?php } ?>
            </tbody>
