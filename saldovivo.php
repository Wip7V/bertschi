       ...
       <div id="principal2">
            <div class="titulo">
                SALDO VIVO
                        ...
                        <div class="botonessup"><a href="saldovivo_impr.php" target="_blank" class="boton"  style="margin-left:30px;">IMPRIMIR LISTADO DUA</a></div><br>
        ...
        <table id="example" >
        	...
        	<tbody>
        		<?php
					 	...
					 	echo "<td>".$item2['id']." - ".$item2['partida']."</td>";
