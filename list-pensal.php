...
<div id="principal2">
    ...
    <div class="formulario">
    	<form method="post" id="formsal" action="list-pensal.php" enctype="multipart/form-data">
        	Codigo DUA: 
        	  <select id="ndua_entrada" name="ndua_entrada" onchange="carga()">
        	<option value="0">Selecciona Codigo DUA</option>
<!--            <option value="">Mostrar todo</option>
-->           <?php 
			$sql="SELECT DISTINCT ndua_entrada FROM ctdua WHERE fecha_salida='' ORDER BY ndua_entrada";
